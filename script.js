...
*/
    ...
    function LoadSignInPageHTML() {
        return (
            <div>
                ...
                <div className="container-inner hide">
                    <div className="flex flex-col justify-center p-2 mt-3 items-center gap-2">
                    ...
                    <div className="flex justify-center items-center gap-2 my-2">
                        <button
                            ...
                            className="google-signin flex justify-center items-center gap-2 border-2 border-gray-300  px-3 py-2 rounded-md"
                            onClick={() => {
    ...
    function LoadMcqPageHTML() {
        ...
        return (
            <div className={`flex flex-col gap-2  w-[${maxWidth}px] mx-auto overflow-y-scroll`}>
                <span className="text-transparent text-center bg-gradient-to-r from-blue-500 to-red-500 bg-clip-text text-xl p-2 font-bold">Practice Random MCQs</span>
                ...
                <div className="flex justify-start items-center gap-5 p-2">
                    <div className="search-mcq flex justify-center items-center gap-2 border rounded-md px-2 py-1 cursor-pointer link" onClick={() => searchMcqs()}>
                        <i className="fa-light fa-magnifying-glass text-sm"></i>
                        <span className="text-sm text-no-wrap opacity-70"> {is_mobile ? "Search" : "Search by text"}</span>
                    </div>

                    <div className="filter-mcq flex justify-center items-center gap-2 border rounded-md px-2 py-1 cursor-pointer link" onClick={() => openOverlay("filter-mcq-overlay")}>
                        <i className="fa-regular fa-filter text-sm"></i>
                        <span className="text-sm text-no-wrap opacity-70">{is_mobile ? "Filter" : "Filter by tags"}</span>
                    </div>
                ...
                <div className="block max-w-[90vw] overflow-x-scroll hide  ">
                    <div className="inline-block mx-2 p-2 border rounded-md px-2 py-1 cursor-pointer link" onClick={() => searchMcqs()}>
                        <i className="fa-light fa-magnifying-glass text-sm"></i>
                        <span className="text-sm text-no-wrap opacity-70"> {is_mobile ? "Search" : "Search by text"}</span>
                    </div>

                    <div className="inline-block mx-2 p-2 border rounded-md px-2 py-1 cursor-pointer link" onClick={() => openOverlay("filter-mcq-overlay")}>
                        <i className="fa-regular fa-filter text-sm"></i>
                        <span className="text-sm text-no-wrap opacity-70">{is_mobile ? "Filter" : "Filter by tags"}</span>
                    </div>

                    <div className="inline-block mx-2 p-2 border rounded-md px-2 py-1 cursor-pointer link" onClick={() => createMCQs()}>
                        <i className="fa-regular fa-add text-sm"></i>
                        <span className="text-sm text-no-wrap opacity-70"> {is_mobile ? "Create" : "Create mcq"} </span>
                    </div>
                    <div
                        className="inline-block mx-2 p-2 border rounded-md px-2 py-1 cursor-pointer link"
                        onClick={(event) => {
                            let overlay_name = "bookmarked-questions-overlay";
                            let overlay_div = document.querySelector(`.${overlay_name}`);
                            overlay_div = document.createElement("div");
                ...
                <div className="subject-div inline-block  w-full px-2 overflow-x-scroll">
                    <span className="text-sm opacity-80 hide">Subject: </span>
                    <div className="inline-block p-2 w-full overflow-x-scroll whitespace-nowrap">
                        {subjects[exam].map((subject, index) => (
                            <span
                                key={index} // Add a key for each child in the list
                                className=" mx-1 border rounded-md bg-gray-50 px-2 py-1 text-sm cursor-pointer subject"
                ...
                <div className="filter-message-div flex justify-start items-start flex-wrap gap-2 p-2 bg-blue-100  rounded-md">
                    <span className="text-sm opacity-70 flex  flex-wrap flex-1 filter-mcq-message text-gray-700 "></span>
                    <span className="clear-filter ml-auto text-sm opacity-70 cursor-pointer link hide text-red-600" onClick={() => clearFilter()}>
                        clear filter
                    </span>
                </div>
    ...
    function NotesPageHTML() {
        return (
            <div>
                ...
                <div className="chapter flex flex-col" id="dwd">
                    <div className="title page-title me-bold text-xl px-2 py-3" id="dwd">
                    ...
                    <div className="children block max-h-[calc(100vh-155px)] p-2 overflow-y-scroll"></div>
                </div>
            </div>
        );
    }
    ...
    function SearchMcqOverlayHTML() {
        return (
            <div className="container search-mcq flex flex-col justify-center items-start gap-2 p-0 h-90vh w-90vw">
                <div className="search-div bg-blue-100 flex justify-center p-4 items-center gap-2 h-full w-full">
                    <div className="flex justify-center items-center gap-2  rounded-md px-2 py-1 border-2 border-gray-400 ">
                        <i className="fa-regular fa-magnifying-glass"></i>
                        <input type="text" className="search-mcq-input bg-blue-100 p-1 align-middle focus:outline-none text-sm" placeholder="Search mcqs by text" onKeyUp={(event) => searchMCQsbyText(event)} />
                        <button className="search-mcq-btn border rounded-md px-2 py-1 cursor-pointer hide" onClick={(event) => searchMCQsbyText(event, "from_search_button")}></button>
                    </div>
                    <i className="fa-regular fa-xmark cursor-pointer text-xl align-right ml-auto" onClick={(event) => closeOverlay(event)}></i>
                </div>
                <div className="w-full flex justify-center items-center gap-2 hide filter-searched-mcqs text-gray-400">
                    <span
                        className="question border-2 rounded-md p-1 text-sm cursor-pointer"
                        onClick={(event) => {
                            event.target
                                .closest(".filter-searched-mcqs")
                            ...
                            //filterSearchedMcqsQuestionOnly(event);
                        }}
                    >
                        In question text
                    </span>
                    <span
                        className="options border-2 rounded-md p-1 text-sm cursor-pointer "
                        onClick={(event) => {
                            event.target
                                .closest(".filter-searched-mcqs")
                                .querySelectorAll("span")
                ...
                <span className="text-sm text-gray-500 w-full text-center searched-mcq-filter-message"></span>
                ...
                <div className="search-results p-3 max-h-[calc(100vh-180px)] overflow-y-scroll  bg-white"></div>
            </div>
        );
    }
    ...
    function searchMCQsbyText(event, search_text) {
        ...
        // if (true) {
        if (event.key == "Enter" || search_text == "from_search_button") {
            let input = document.querySelector(".search-mcq-overlay input.search-mcq-input");
            let input_value = input.value.trim();
            if (search_text) {
                input_value = search_text;
                input.value = search_text;
            }
            //input_value = search_text ? search_text : input_value;
            if (input_value != "") {
                let searh_result_div = document.querySelector(".search-mcq .search-results");
                ...
                searched_ques.forEach((que) => {
                    ...
                    span.className = "text-sm link w-full text-right cursor-pointer";
    ...
    function filterMcqsBySubject(subject, event) {
        ...
        let subjects = subject_div.querySelectorAll(".link");
            ...
            <div>
                <div id={que.id} className="que-div min-w-320 max-w-90 my-2 w-[min(400px, 90%)] flex flex-col gap-2 box-border border-2 rounded-md p-5">
                    ...
                    <div className="options flex flex-col gap-2">
                        ...
                        <div className="tags  border-t border-gray-500 hide"></div>
    ...
    function McqTagsHTML({ que }) {
        return (
            <div className={`tags-inner border-t border-gray-500 que-tags inline-block p-2 items-center ${is_mobile ? "max-w-[80vw]" : "max-w-full"} overflow-x-scroll whitespace-nowrap`}>
                ...
                {que.tags.map((tag, index) => {
                    ...
                    return (
                        <span className=" que-tag tag inline-block text-no-wrap borde-0 mx-2 bg-blue-50 rounded-md   link px-2 py-1 cursor-pointer" key={index} onClick={(event) => filterMcqsByTag(tag, event)}>
    ...
    function filterMcqsByExam(exam, event) {
        ...
        curr_que_index = 0;
        openMcq(filtered_ques[0]);
        let filter_message = `Filter:  ${filtered_ques.length} mcqs found for exam "${capitalFirstLetterOfEachWord(exam)}"`;
        setFilterMcqsMessage(filter_message);
    }
    ...
    function McqFilterTagsHTML() {
        return (
            <div className=" container flex flex-col justify-center items-start gap-2 ">
                <div className=" bg-blue-100 flex justify-center p-3 items-center gap-2 h-full w-full">
                    <div className="input-div flex justify-center items-center gap-2 border-2 border-gray-400 rounded-md px-2 py-1">
                        <i className="fa-regular fa-filter"></i>
                        <input type="text" className="bg-blue-100 p-1 align-middle focus:outline-none" placeholder="Filter mcqs" onChange={(event) => filterMcqTagItems(event)} />
                    </div>
                    <i className="fa-regular fa-xmark cursor-pointer text-md ml-auto" onClick={(event) => closeOverlay(event)}></i>
                </div>
                ...
                <div className="tab-section h-full w-full">
                    ...
                    <div className="tab-containers p-3 flex ">
                        <div className="tab-container subject-wise max-h-[calc(100vh-140px)] overflow-y-scroll mb-20px "> </div>
                        <div className="tab-container all-tags hide gap-2 flex justify-start flex-wrap  max-h-[calc(100vh-140px)] overflow-y-scroll mb-20px"></div>
                    </div>
                </div>
            </div>
        );
    ...
    */
        ...
        let filter_message = `Filter:  ${filtered_ques.length} mcqs found for #[${capitalFirstLetterOfEachWord(tag)}]`;
        setFilterMcqsMessage(filter_message);
    }
        ...
        return (
            <div>
                <span className="flex gap-2 justify-center items-center">
                    <span className="today-date text-md font-bold  text-gray-700">Today: {getTodayDateMMddyyyy()}</span>
                    <span className="today-day bg-orange-200  px-2 py-1 text-[10px] rounded-md hide">{getTodayDay()}</span>
                    <div className="today-practised-questions-count flex gap-2 justify-center items-center ml-auto px-2">
                        <span
                            className="total bg-gray-100 rounded-full px-2 py-1 cursor-pointer"
                            onClick={() => {
                        ...
                        <span
                            className="correct bg-green-100 rounded-full px-2 py-1 cursor-pointer"
                            onClick={() => {
                                let overlay = document.querySelector(".me-overlay.today-practised-questions-overlay");
                                if (!overlay) {
                                    overlay = document.createElement("div");
                        ...
                        <span
                            className="wrong bg-red-100 rounded-full px-2 py-1 cursor-pointer"
                            onClick={() => {
                                let overlay = document.querySelector(".me-overlay.today-practised-questions-overlay");
                                if (!overlay) {
                                    overlay = document.createElement("div");
                ...
                <div className="today-practised-questions-list flex gap-2  my-2 border-2 border-gray-300 rounded-md justify-center items-center w-full">
                    <span className="hide previous-question bg-gray-200 border w-[20px] rounded-md p-1 m-1 text-gray-700 cursor-pointer"> {"<"} </span>
                    <span className="questions-list inline-block py-2 px-1 flex-1 questions-list max-w-[80vw] overflow-x-scroll">
                        {today_questions.map((question, index) => (
                            <span
                                className={`question border rounded-md m-1 px-2 py-1 cursor-pointer ${question.selected_option_id == question.correct_option_id ? "bg-green-100" : "bg-red-100 "} `}
                                key={index}
                                onClick={() => {
    ...
    function TodayPractisedQuestionsOverlayHTML({ today_questions, type }) {
        return (
            <div className="container">
                <div className="header py-3 px-2 flex justify-start items-center gap-2 text-gray-600">
                    <span className="text-md font-bold">{type ? (type == "all" ? "Today All Practsed Questions" : type == "correct" ? "Today Correct Practsed Questions" : "Today Wrong Practsed Questions") : " Practised Questions"}</span>
                    <i
                        className="fa-regular fa-circle-xmark text-xl cursor-pointer"
                        onClick={(event) => {
                            event.target.closest(".me-overlay").remove();
                ...
                <div className="content block max-h-[90vh] my-3 overflow-y-scroll">
                    {today_questions.map((question, index) => {
                        ...
                        return (
                            <div key={index} className="question-div m-2">
                                ...
                                <span
                                    className="link cursor-pointer mb-5 inline-block text-right pr-[20px] w-full"
                                    onClick={(event) => {
                                        openMcq(question.id, null, "daily", question.selected_option_id, index + 1);
                                        closeOverlay(event);
                                    }}
